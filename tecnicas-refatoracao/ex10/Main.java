...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DadosBancarios dadosBancarios = new DadosBancarios("Banco Acadêmico","1234",
                "98765-0", "Pix" );
        ...
        DadosSeguradora dadosSeguradora = new DadosSeguradora("Seguro Total",
                "AP-889900", "0800-123-456");
